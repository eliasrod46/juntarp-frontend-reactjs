...
export const IndexFolders = () => {
  ...
  return (
    <div>
      <div >
        <ul className="flex flex-wrap -mb-px text-sm font-medium justify-center text-gray-500 dark:text-gray-400">
          ...
          <li className="me-2">
            <button
              onClick={() => setTab(4)}
              className={tab === 4 ? tabActivaClass : tabInactivaClass}
            >
              <svg
                className={tab === 4 ? iconoActivoClass : iconoInactivoClass}
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
                viewBox="0 0 18 18"
      ...
      {tab == 4 ? (
        <div>
          <h2 className="text-center text-xl my-4">Carpetas fuera archivo</h2>
