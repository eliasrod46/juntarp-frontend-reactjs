...
export const getElementsHistoryIngresoApi = async (authTokens) => {
  return await getElementsBase(
    authTokens,
    `${endpointURL}/history-ingreso-folders`
  );
};
...
export const createElementsApi = async (authTokens) => {
    
  return await getElementsBase(authTokens, `${endpointURL}/create-folders`);
};
